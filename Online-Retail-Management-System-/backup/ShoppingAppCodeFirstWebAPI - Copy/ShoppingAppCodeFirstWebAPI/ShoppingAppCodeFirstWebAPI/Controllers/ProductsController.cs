...
namespace ShoppingAppCodeFirstWebAPI.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public ProductsController(ShoppingAppDb context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Products>> PostProducts(Products products)
        {
...

            {
                ...
                var existingSubCategory = _context.SubCategorys.Find(products.SubCategoryId);
...

                {
                    ...
                    products.SubCategoryName = existingSubCategory;
            ...
            //if (_context.Products == null)
            //{
            //    return Problem("Entity set 'ShoppingApplicationDbContext.Products'  is null.");
            //}
            //  _context.Products.Add(products);
            //  await _context.SaveChangesAsync();
