...
namespace ShoppingAppCodeFirstWebAPI.Controllers
{
    ...
    public class OrderDetailsController : ControllerBase
    {
        ...
        public OrderDetailsController(ShoppingAppDb context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<OrderDetails>> PostOrderDetails(OrderDetails orderDetails)
        {
            ...
            //    var existingOrder = _context.Orders.Find(orderDetails.OrderId);

            //    if (existingOrder != null && existingProduct != null)
            //    {
            //        orderDetails.OrderId = existingOrder;
            //        orderDetails.ProductName = existingProduct;

            //        _context.ShoppingCart.Add(orderDetails);
            ...
            if (_context.OrderDetails == null)
            {
                return Problem("Entity set 'ShoppingApplicationDbContext.OrderDetails'  is null.");
            }
